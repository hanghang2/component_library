...
export default {
	...
	mounted() {
		if (!this.type) {
			...
			this.buttonType = "zlButton-" + this.type + " ";
		}
		if (this.plain == "") {
			this.isplain = "zlButton-isplain ";
		} else {
			this.isplain = " ";
		}
		if (this.round == "") {
